...
public class UrlBuilder {
	...
	public static String getWeChatAuthorizeUrl(String clientId, String redirectUrl) {
		return MessageFormat.format(WECHAT_AUTHORIZE_PATTERN, AuthSource.WECHAT.authorize(), clientId, redirectUrl, System.currentTimeMillis());
	}
	...
	public static String getTaobaoAuthorizeUrl(String clientId, String redirectUrl) {
		return MessageFormat.format(TAOBAO_AUTHORIZE_PATTERN, AuthSource.TAOBAO.authorize(), clientId, redirectUrl, System.currentTimeMillis());
	}
	...
	public static String getGoogleAuthorizeUrl(String clientId, String redirectUrl) {
		return MessageFormat.format(GOOGLE_AUTHORIZE_PATTERN, AuthSource.GOOGLE.authorize(), clientId, redirectUrl, System.currentTimeMillis());
	}
	...
	public static String getDouyinAuthorizeUrl(String clientId, String redirectUrl) {
		return MessageFormat.format(DOUYIN_AUTHORIZE_PATTERN, AuthSource.DOUYIN.authorize(), clientId, redirectUrl, System.currentTimeMillis());
	}
	...
	public static String getToutiaoAuthorizeUrl(String clientId, String redirectUrl) {
		return MessageFormat.format(TOUTIAO_AUTHORIZE_PATTERN, AuthSource.TOUTIAO.authorize(), clientId, redirectUrl, System.currentTimeMillis());
	}
